...
将对应 MP4 放入 `assets/videos/`，并使用下列文件名即可在 README 中嵌入播放：

<table>
  <tr>
    <td width="50%" valign="top">
      <video src="assets/videos/clothes_folding.mp4" controls playsinline muted preload="metadata" width="100%"></video>
      <p align="center"><strong>衣物折叠</strong><br><a href="task_suites/clothes_folding_zh.md">打开指南</a></p>
    </td>
    <td width="50%" valign="top">
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p align="center"><strong>运行时概览</strong><br><em>Cobot Magic / 单臂 Piper 部署</em></p>
    </td>
  </tr>
</table>
